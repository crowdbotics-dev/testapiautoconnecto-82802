...
## Project Structure
    ...
    ├── testapiautoconnecto_82802  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_82802`
...
2. Clone this repo and `cd testapiautoconnecto_82802`
